...
<table class="tadmin">
    ...
    <tr>
        ...
        <td class="center">
            <input type="text" name="matieres[{$Row.id}][moyenne]" value="{$Row.moyenne}"/>
        </td>
        <td class="center">
            <textarea name="matieres[{$Row.id}][observation]" cols="40">{$Row.observation}</textarea>
        </td>
    </tr>
    {/foreach}
    </tbody>
...
<dl>
	...
	<dd><textarea name="trimestre[observation_etablissement]" id="observation_etablissement" rows="4" cols="40">{$Trimestre.observation_etablissement}</textarea></dd>
</dl>
<dl>
	<dt><label for="observation_structure">{$lang.Observation_structure} :</label></dt>
	<dd><textarea name="trimestre[observation_structure]" id="observation_structure" rows="4" cols="40">{$Trimestre.observation_structure}</textarea></dd>
</dl>
<br/>
