...
class Form{
	...
	private function constructForm(){
		foreach( $this->champs_in_db as $Champ):
			$this->form .= '<div class="control-group"><label class="control-label" for="'. $Champ['cf_name'] .'">'. $Champ['cf_name'] .' :</label>';
	...
	private function addInputText( $Champ ){
		$this->form .= '<div class="controls"><input type="text" name="formp['.$Champ['id'].']" id="'. $Champ['cf_name'] .'" ';
	...
	private function addSelect( $Champ ){
		...
		$this->form .= '<div class="controls"><select name="formp['.$Champ['id'].']" id="'. $Champ['cf_name'] .'" ';
