...
<body>
		...
		<div id="header">
			...
			<div class="fright" id="header_right">
				...
				<form action="http://www.google.fr" id="cse-search-box" target="_blank">
				  <div>
					<input type="hidden" name="cx" value="partner-pub-1710313297381782:9270974458" />
	...
	<div class="clear"></div>
	<div class="center">Powered by <a href="http://www.goliath-software.com" title="" target="_blank">GOLIATH</a></div>
</body>
</html>